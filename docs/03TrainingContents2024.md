...
| Module | Learning Objectives |  
| --- | --- | 
| [Analyzing text](https://learn.microsoft.com/en-us/training/modules/analyze-text-ai-language/) | - Detect language and extract key phrases <br> - Analyze sentiment and detect PII <br> - Summarize text <br> - Extract entities and linked entities |
