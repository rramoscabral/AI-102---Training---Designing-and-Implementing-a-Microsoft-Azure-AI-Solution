...
The exam measured skills are constantly being updated due to dynamic cloud services. So it is highly recommended to always consult the official exam page [**here**](https://docs.microsoft.com/en-us/learn/certifications/exams/AI-102).
...
- [Practice Assessment for Exam AI-102: Design and implement an Azure AI solution using Azure AI services, Azure AI Search, and Azure Open AI ](https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-engineer/practice/assessment?assessment-type=practice&assessmentId=61&practice-assessment-type=certification)
...
- [measureup](https://www.measureup.com/microsoft-practice-test-ai-102-designing-and-implementing-an-azure-ai-solution.html#u5).
- [mindhub](https://eu1.mindhub.com/ai-102-designing-and-implementing-an-azure-ai-solution-microsoft-official-practice-test/p/MU-AI-102).
